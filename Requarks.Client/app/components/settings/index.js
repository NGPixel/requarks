...
var Settings = (function (_super) {
    ...
    function Settings(props) {
        ...
        this.onSaveSettings = function () {
            ...
            AppConfig.data.locale = _this.state.form_locale;
        ...
        this.onSaveService = function () {
            AppConfig.data.service_domain = _this.state.form_service_domain;
            AppConfig.save();
            _this.setState({ snackSuccessOpen: true });
        };
    ...
    Settings.prototype.render = function () {
        ...
        var firstNameLetter = AppConfig.user.name.substr(0, 1).toUpperCase();
        var UsrAvatar = (AppConfig.user.picture != null && AppConfig.user.picture.length > 10) ?
            React.createElement(Mui.Avatar, {src: AppConfig.user.picture, size: 120}) :
